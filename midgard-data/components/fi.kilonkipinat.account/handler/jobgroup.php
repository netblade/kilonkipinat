 ...
 * @package fi.kilonkipinat.account
 */
class fi_kilonkipinat_account_handler_jobgroup extends midcom_baseclasses_components_handler_crud
{
    var $_jobgroup = null;
    ...
    {
        $object = new fi_kilonkipinat_account_jobhistory_jobgroup_dba($args[0]);
