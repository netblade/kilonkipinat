...
<?php
$_MIDCOM->dynamic_load('/midcom-substyle-dl_frontpage/ajankohtaista/tapahtumat/upcoming/trips/4');
?>
                </div>
            </div></div></div></div>
            </div></div></div></div>
            ...
            <div class="tl"><div class="tr"><div class="bl"><div class="br">
                <div class="frontpage_lift_content">
<?php
$_MIDCOM->dynamic_load('/midcom-substyle-dl_frontpage/ajankohtaista/tapahtumat/upcoming/meetings/4');
?>
                </div>
            </div></div></div></div>
            </div></div></div></div>
